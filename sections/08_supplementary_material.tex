...
\begin{figure}[ht]
  \centering
  \subfloat[Full exploratory population.]{\includegraphics[width=0.47\textwidth]{./images/output_results_from_SDE/ccu085_040_baseline_hazard_from_cox_proportional_hazard_ratio_model_survival_in_year_following_stroke_exploratory_population.png}\label{stroke_survival_baseline}}
  \hfill
  \subfloat[Causal population.]{\includegraphics[width=0.47\textwidth]{./images/output_results_from_SDE/ccu085_050_baseline_hazard_from_cox_proportional_hazard_ratio_model_survival_in_year_following_stroke_causal_population.png}\label{control_survival_baseline}}
